...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Arnix " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"arnixtools.com", "46.197.145.16"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"arnixtools.com", "testnet-seed.arnixtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Arnix is probably already running."), addrBind.ToString().c_str());
        else
